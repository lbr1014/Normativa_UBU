...
TRANSLATIONS = {
    "es": {
        ...
        "rag.subtitle": "Escribe tu pregunta y revisa la respuesta generada junto al fragmento utilizado.",
    ...
    "en": {
        ...
        "rag.subtitle": "Write your question and review the generated answer along with the fragment that was used.",
