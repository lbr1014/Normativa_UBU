...
TRANSLATIONS_EN={
    ...
    "docs.manage_subtitle": "Upload documents into the system, convert them to Markdown, or update the vector database.",
    ...
    "docs.view_chunks": "View document chunks",
    "docs.chunks_details": "Indexed document chunks",
    "docs.section": "Section",
    "docs.pdf_date": "PDF date",
    "docs.text": "Text",
    "docs.keywords": "Keywords",
    "docs.chunk_text_unavailable": "Text unavailable in Qdrant.",
    "documents.no_job_id": "The process tracker could not be started.",
    "documents.status_error": "The document process status could not be checked.",
    "documents.unknown_state": "Unknown document state.",
    "documents.upload.starting": "Starting document upload...",
    "documents.upload.running": "Uploading documents... {progress}%",
    "documents.upload.processing": "Uploading {name}...",
    "documents.upload.done": "Upload completed. {count} documents uploaded.",
    "documents.upload.done_with_failures": "Upload completed. {count} documents uploaded and {failed} failed.",
    "documents.upload.failed": "Document upload failed.",
    "documents.upload.start_error": "Document upload could not be started.",
    "documents.delete.starting": "Starting document deletion...",
    "documents.delete.running": "Deleting documents... {progress}%",
    "documents.delete.processing": "Deleting {name}...",
    "documents.delete.done": "Deletion completed. {count} documents deleted.",
    "documents.delete.done_with_failures": "Deletion completed. {count} documents deleted and {failed} failed.",
    "documents.delete.failed": "Document deletion failed.",
    "documents.delete.start_error": "Document deletion could not be started.",
    ...
    "rag.mode_chat": "Chat",
    "rag.mode_form": "Form",
    "rag.chat_question_tooltip": "You can mention the document, title, or section directly in your question.",
    "rag_default.expediente_tooltip": "Select the document you want to ask about. Leave it as a general query to search all documents.",
    "rag_default.doc_type_tooltip": "Filter the document type.",
    "rag_default.question_kind_tooltip": "Choose whether you want a summary or an explanation of document sections.",
    ...
    "rag_default.subtitle": "Choose a document and the type of explanation you need to send a guided query to the model.",
    "rag_default.expediente_label": "Documents",
    "rag_default.expediente_any": "General query (all documents)",
    "rag_default.expediente_help": "If you leave it empty, the question will be asked over all available documents.",
    ...
    "rag_default.question_summary": "Document summary",
    ...
    "rag_default.section_empty": "The selected document has no detected sections.",
