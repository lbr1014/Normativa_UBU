...
def get_client_translations() -> dict[str, str]:
    ...
    keys = [
        ...
        "rag_default.section_any",
        "rag_default.section_tooltip",
        "rag_default.section_empty",
        ...
        "tutorial.auth.name.title",
        "tutorial.auth.email.title",
        "tutorial.auth.country.title",
        "tutorial.auth.password.title",
        "tutorial.auth.confirm_password.title",
        "tutorial.auth.submit.title",
        "tutorial.auth.login.email.desc",
        "tutorial.auth.login.password.desc",
        "tutorial.auth.login.submit.desc",
        "tutorial.auth.signup.name.desc",
        "tutorial.auth.signup.email.desc",
        "tutorial.auth.signup.country.desc",
        "tutorial.auth.signup.password.desc",
        "tutorial.auth.signup.confirm_password.desc",
        "tutorial.auth.signup.submit.desc",
        "tutorial.auth.forgot.email.desc",
        "tutorial.auth.forgot.submit.desc",
        "tutorial.auth.new_password.title",
        "tutorial.auth.reset.password.desc",
        "tutorial.auth.reset.confirm_password.desc",
        "tutorial.auth.reset.submit.desc",
