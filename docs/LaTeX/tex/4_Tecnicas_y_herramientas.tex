...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{p{0.20\columnwidth} p{0.36\columnwidth} p{0.36\columnwidth}}
		\toprule
			Herramienta & \textbf{Ventajas} & \textbf{Desventajas} \\
		\midrule
