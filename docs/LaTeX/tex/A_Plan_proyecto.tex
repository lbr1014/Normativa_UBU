...
Para llevar a cabo el estudio de la viabilidad económica se va a considerar que el trabajo llevado a cabo por la alumna lo ha realizado un desarrollador contratado durante los 9 meses que ha durado el proyecto. 

Para estimar el coste laboral se supone un escenario empresarial real en España, tomando como referencia el \myhref{https://www.ufv.es/cuanto-cobra-un-ingeniero-informatico-por-mes-preguntas-grados/}{Salario Medio de un Graduado en Ingeniería Informática}, que se corresponde a unos 25\,000\,€ brutos al año. Esto equivale a 1\,785\,€ brutos al mes (se divide en 14 pagas). 

Al salario bruto del trabajador debe añadirse la cotización empresarial a la \myhref{https://www.seg-social.es/wps/portal/wss/internet/Trabajadores/CotizacionRecaudacionTrabajadores/36537}{Seguridad Social}. Normalmente la empresa asume diferentes conceptos de cotización, siendo el principal el correspondiente a las contingencias comunes. Además, debe contribuir por desempleo, Fondo de Garantía Salarial (FOGASA), formación profesional y el Mecanismo de Equidad Intergeneracional (MEI). También, se ha considerado una cotización del 1,5\% por accidentes de trabajo y enfermedades profesionales, correspondiente a una actividad de desarrollo de \eng{software} con bajo riesgo laboral. Esta cotización depende de la actividad económica de la empresa y del nivel de riesgo del puesto de trabajo. En conjunto, estos conceptos suponen aproximadamente un 32,15,\% adicional sobre la base de cotización del trabajador (ver Tabla~\ref{tabla:cotizaciones}).
\begin{table}[p]
	\centering
	\begin{tabularx}{\linewidth}{p{0.40\linewidth} *{3}{>{\centering\arraybackslash}X}}
		\toprule
		\textbf{Concepto} &
		\textbf{Empresa (\%)} &
		\textbf{Trabajador (\%)} &
		...
		Accidentes de trabajo y \mbox{enfermedades profesionales} &
		1,50 &
		-- &
		1,50 \\
		...
		\bottomrule
	\end{tabularx}
	\caption{Cotizaciones a la Seguridad Social.}
	\label{tabla:cotizaciones}
\end{table}

Teniendo en cuenta el salario bruto y las cotizaciones empresariales a la Seguridad Social el gasto mensual final por la contratación del desarrollado sería:

$$
1\,785\frac{\,\text{\texteuro}}{\,\text{meses}} \cdot 1,3215
= 2\,358,88\,\text{\texteuro}
$$

El gasto total tras los 9 meses que ha durado el desarrollo sería:

$$
1\,785\frac{\,\text{\texteuro}}{\,\text{meses}} \cdot 1,3215 \cdot 9\,\text{meses}
= 21\,229,90\,\text{\texteuro}
$$
...
\begin{table}[h]
	...
	\begin{tabularx}{\linewidth}{
		...
		\midrule
		Coste total del proyecto & 32\,458,96 \\
		\bottomrule
	\end{tabularx}
