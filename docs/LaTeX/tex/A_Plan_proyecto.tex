...
Como objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/26?closed=1}{Sprint 26} se decidió explicar algunos de los apartados que faltan de los anexos y la memoria. Concretamente se va a explicar el manual del programador, y se va a comenzar con el manual del usuario. También, se va a seguir redactand la viabilidad y los aspectos importantes durante el desarrollo. Para llevar a cabo estos objetivos se plantearon las siguientes tareas:
...
Para realizar el \eng{sprint} se estimaron 32 horas de trabajo. Tras finalizar el \eng{sprint} se explicarón todos los apartados en el tiempo estimado.
...
%Como objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/27?closed=1}{Sprint 27}

%Para llevar a cabo estos objetivos se plantearon las siguientes tareas:


%Para realizar el \eng{sprint} se estimaron  horas de trabajo
...
%Como objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/28?closed=1}{Sprint 28}
...
%Como objetivo principal del \myhref{https://github.com/lbr1014/TFG_RAG/milestone/29?closed=1}{Sprint 29}
...
El estudio de viabilidad es un análisis detallado que se realiza antes de iniciar un proyecto. Sirve para determinar la rentabilidad de ese proyecto, es decir, si se pude hacer realidad. Para ello se analiza si es económicamente rentable (ver sección~\hyperref[viabilidad_economica]{A.3.1}) y legalmente viable (ver sección~\hyperref[viabilidad_legal]{A.3.2}). 
...
\textbf{Protección de datos personales}\label{subsec:proctdatos}
...
\textbf{Propiedad intelectual y derechos de autor}\label{subsec:propiedad}
...
\tablaMultipaginaColor
	{Licencias de las herramientas de la aplicación.}
	{|L{0.2\columnwidth}|L{0.2\columnwidth}|L{0.6\columnwidth}|}
	{3}
	{licencias}
	{\textbf{Herramienta} & \textbf{Licencia} & \textbf{Uso en el sistema}}
	{		Flask & BSD-3-Clause & \eng{Framework web} ligero en Python utilizado para desarrollar la aplicación web del sistema PythIA \\
		Jinja2 & BSD-3-Clause & Motor de plantillas utilizado por Flask para generar HTML dinámico\\
		Werkzeug & BSD-3-Clause & Biblioteca WSGI utilizada por Flask para routing, peticiones HTTP y utilidades web\\
		Flask-Loging & MT & Gestión de autenticación, sesiones y control de usuarios autenticados.\\
		Flask-WTF & BSD-3-Clause & Integración de formularios WTForms con Flask y protección CSRF.\\
		WTForm & BSD-3-Clause & Biblioteca para validación y gestión de formularios web. \\
		...
		Qdrant & Apache Licence 2.0 & Base de datos vectorial especializada en búsqueda semántica mediante embeddings \\
		...
		Playwright & Apache License 2.0 & Framework de automatización web utilizado para Web Scraping dinámico \\
		Selenium & Apache License 2.0 & Herramienta de automatización de navegadores utilizada para pruebas y scraping web \\
		Beautiful Soup & MIT & Biblioteca para parsear y extraer información de documentos HTML/XML \\
		Requests & Apache License 2.0 & Biblioteca HTTP utilizada para realizar peticiones web \\
		Transformers (Hugging Face) & Apache License 2.0 & Biblioteca para cargar y utilizar modelos LLM y modelos de \eng{embeddings} \\
		Sentence Transformers & Apache License 2.0 & Biblioteca especializada en generación de \eng{embeddings} semánticos \\
	...
	pytest & MIT & Framework de testing utilizado para pruebas unitarias y funcionales \\
...
\textbf{Legalidad del \eng{Web Scraping}}\label{subsec:webScraping}
...
\textbf{Seguridad Informática}\label{subsec:seg}
