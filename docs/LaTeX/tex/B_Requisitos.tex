...
\begin{itemize}
\tightlist
	\item \textbf{CU-01} Registro de usuarios (ver tabla~\ref{req-01}).
	\item \textbf{CU-02} Iniciar sesión (ver tabla~\ref{req-02}).
	\item \textbf{CU-03} Cerrar sesión (ver tabla~\ref{req-03}).
	\item \textbf{CU-04} Recuperar contraseña (ver tabla~\ref{req-04}).
	\item \textbf{CU-05} Realizar consulta al \eng{RAG} (ver tabla~\ref{req-05}).
	\item \textbf{CU-06} Consultar historial de consultas (ver tabla~\ref{req-06}).
	\item \textbf{CU-07} Borrar consultas del historial (ver tabla~\ref{req-07}).
	\item \textbf{CU-08} Gestión de documentos (ver tabla~\ref{req-08}).
	\item \textbf{CU-09} Cargar documentos de licitaciones (ver tabla~\ref{req-09}).
...
\end{itemize}
El diagrama de los casos de uso general se muestra en la imagen~\ref{fig:Diagramas/CasosUso}.
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-01}}    & \textbf{Registro de usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		...
		\bottomrule
	\end{tabularx}
	\caption{\textbf{CU-01} Registro de usuarios.}
	\label{req-01}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-02}}    & \textbf{Iniciar sesión}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-03}}    & \textbf{Cerrar sesión}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-04}}    & \textbf{Recuperar contraseña}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\bottomrule
	\end{tabularx}
	\caption{\textbf{CU-04} Recuperar contraseña.}
	\label{req-04}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-05}}    & \textbf{Realizar consulta al \eng{RAG}}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\bottomrule
	\end{tabularx}
	\caption{\textbf{CU-05} Realizar consulta al \eng{RAG}.}
	\label{req-05}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-06}}    & \textbf{Consultar historial de consultas}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\bottomrule
	\end{tabularx}
	\caption{\textbf{CU-06} Consultar historial de consultas.}
	\label{req-06}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-07}}    & \textbf{Borrar consultas del historial}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\bottomrule
	\end{tabularx}
	\caption{\textbf{CU-07} Borrar consultas del historial.}
	\label{req-07}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-08}}    & \textbf{Gestión de documentos}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\bottomrule
	\end{tabularx}
	\caption{\textbf{CU-08} Gestión de documentos.}
	\label{req-08}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{\textbf{CU-09}}    & \textbf{Cargar documentos de licitaciones}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\bottomrule
	\end{tabularx}
	\caption{\textbf{CU-09} Cargar documentos de licitaciones.}
	\label{req-09}
\end{table}
