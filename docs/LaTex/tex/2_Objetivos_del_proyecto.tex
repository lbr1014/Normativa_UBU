...
El objetivo principal del proyecto es diseñar e implementar un sistema de \textit{Retrieval-Augmented Generation} (RAG) que permita enriquecer las respuestas de un modelo de lenguaje mediante la recuperación y utilización de información contextual proveniente de una colección documental. 
...
\item Desarrollar la capa de interacción con el usuario
	\begin{itemize}
		...
		\item Integrar los fragmentos en el \textit{prompt} para enriquecer la respuesta de los \textit{Large Language Model} (LLM).
	\end{itemize}
\item Desarrollar interfaz amigable para el usuario.
	\begin{itemize}
