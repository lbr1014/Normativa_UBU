...
Para el \textit{web scraping} se ha valorado usar \href{https://beautiful-soup-4.readthedocs.io/en/latest/}{Beautiful Soup}, \href{https://selenium-python.readthedocs.io/}{Selenium}, \href{https://playwright.dev/}{Playwright} y \href{https://requests.readthedocs.io/en/latest/}{Requests}. Finalmente se ha elegido usar 