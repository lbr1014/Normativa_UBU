...
\tightlist
	...
	\item CU-8 Importar licitaciones automáticamente
	\item CU-9 Procesar documentos cargados
	\item CU-10 Indexar documentos
	\item CU-11 Actualizar la base de datos vectorial
	\item CU-12 Listar documentos
	\item CU-13 Consultar estado de los documentos
	\item CU-14 Eliminar documento
	\item CU-15 Gestión de usuarios
	\item CU-16 Crear usuarios
	\item CU-17 Borrar usuarios
	\item CU-18 Modificar rol del usuario
	\item CU-19 Editar usuario
\end{itemize}
El diagrama de los casos de uso se muestra en esta imagen ~\ref{fig:Diagramas/CasosUso}.

\imagendiagram{Diagramas/CasosUso}{Diagrama de casos de uso.}{1.2}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\begin{enumerate}
			...
			\item El sistema llama al \textit{LLM} y genera una respuesta.
		...
		\begin{enumerate}
			...
			\item \textit{Timeout} del \textit{LLM}. El sistema muestra un mensaje controlado. 	
		\end{enumerate}\\
		\textbf{Importancia}          & Alta  \\
		\bottomrule
	\end{tabularx}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-8}    & \textbf{Importar licitaciones automáticamente}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-8 Importar licitaciones automáticamente.}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-9}    & \textbf{Procesar documentos cargados}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-2, RF-2.1, RF-2.2, RF-2.2.1, RF-2.3, RF-2.3.1, RF-2.3.2, RNF-3, RNF-3.1 \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-9 Procesar documentos cargados.}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-10}    & \textbf{Indexar documentos}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-10 Indexar documentos.}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-11}    & \textbf{Actualizar la base de datos vectorial}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-1, RF-5.4, RF-10.3 \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-11 Actualizar la base de datos vectorial.}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-13}    & \textbf{Consultar estado de los documentos}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-1.2, RNF-4 \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-13 Consultar estado de los documentos.}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-15}    & \textbf{ Gestión de usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		...
		\begin{enumerate}
			...
			\item Si no hay usuarios registrados en la aplicación. Muestra un mensaje.
		\end{enumerate}\\
		\textbf{Importancia}          & Media  \\
		\bottomrule
	\end{tabularx}
	\caption{CU-15 Gestión de usuarios.}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-16}    & \textbf{ Crear usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-10.3, RF-10.4 \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-17}    & \textbf{ Borrar usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-10.3, RF-10.4 \\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-18}    & \textbf{ Modificar rol del usuarios}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
		\textbf{Requisitos asociados} & RF-10.3, RF-10.4 \\
		...
		\bottomrule
	\end{tabularx}
	\caption{CU-18 Modificar rol del usuarios.}
\end{table}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		\toprule
		\textbf{CU-19}    & \textbf{ Editar usuario}\\
		\toprule
		\textbf{Versión}              & 1.0    \\
		\textbf{Autor}                & Lydia Blanco Ruiz \\
