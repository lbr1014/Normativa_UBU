...
\tightlist
	...
	\end{itemize}
	\item RF-7 Construcción del \textit{prompt} con contexto: el sistema debe construir un \textit{prompt}, para alimentar al \textit{LLM}, que incluya los \textit{chunks} recuperados, la pregunta del usuario y reglas de uso del contexto.
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\begin{enumerate}
			...
			\item El sistema valida el formato y que el \textit{email} no este duplicado.
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\begin{enumerate}
			...
			\item El \textit{email} no cumple la validación. Mostrar error de \textit{email} inválido.
			\item La contraseña no cumple la política. ostrar error de contraseña poco segura.		
		\end{enumerate}\\
		\textbf{Importancia}          & Alta  \\
		\bottomrule
	\end{tabularx}
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\textbf{Precondición}         & Que el administrador este autentificado y haya un programa de \textit{web scraping} funcional. \\
		\textbf{Acciones}             &
		\begin{enumerate}
			\def\labelenumi{\arabic{enumi}.}
			\tightlist
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\begin{enumerate}
			\def\labelenumi{\arabic{enumi}.}
			\tightlist
			\item Fallo al conectara con la base de datos. No se cambia el rol del usuario.
		\end{enumerate}\\
...
\begin{table}[p]
	...
	\begin{tabularx}{\linewidth}{ p{0.21\columnwidth} p{0.71\columnwidth} }
		...
		\begin{enumerate}
			...
			\item El sistema guarda los cambios. Si hay cambio de contraseña la almacena \textit{hasheada}.
		\end{enumerate}\\
