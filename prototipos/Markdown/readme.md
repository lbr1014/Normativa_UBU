...
En esta carpeta se encuentran los archivos de prueba que se han ido generando durante el desarrollo del proyecto para la conversión de pdfs a archivos Markdown.. 
